    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <h3 class="mb-30"><b>Crear noticia</b></h3>
          <form name="crearNoticia" action="TODO.do" method="post">
            ...
            <div class="row form-block form-plr-15 form-h-45 form-mb-20">
              <div class="col-sm-12">
                ...
                <input class="brdr-grey" type="text" name="titulo" placeholder="Título"
              ...
              <div class="col-sm-12">
                ...
                <textarea class="brdr-grey p-10" type="text" name="cuerpo" rows=8
                  value="<c:out value="${param.nacimiento}"/>"></textarea>
              </div>

              <div class="col-sm-12">
                <label for="url">URL de la fuente</label>
								<c:out value="${requestScope.errores.get('url')}" escapeXml="false"/>
                <input class="brdr-grey" type="text" name="url" placeholder="URL de la fuente"
            ...
            <div class="row">
              <div class="col-sm-12 mt-30">
                <button class="w-100 btn-fill-primary" type="submit"><b>Enviar noticia</b></button>
              </div>
            </div>
