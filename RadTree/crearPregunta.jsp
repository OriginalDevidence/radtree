					...
					<form name="crearPregunta" action="CrearPregunta.do" method="post">
						...
						<div class="row form-block form-plr-15 form-h-45 form-mb-20 form-brdr-lite-white">
							...
							<div class="col-12">
								...
								<c:out value="${requestScope.errores.get('enunciado')}" escapeXml="false"/>
								<input class="mt-5" type="text" name="enunciado" placeholder="Título de la pregunta"
							...
							<div class="pl-50 pl-sm-25 col-12">
								<button class="plr-10 btn-b-md btn-fill-primary" type="submit" name="button" value="annadirRespuesta">
									<i class="ion-plus-round"></i>
								</button>
								<button class="plr-10 btn-b-md btn-fill-primary" type="submit" name="button" value="quitarRespuesta">
						...
						<div class="row">
							<div class="col-12 mt-30">
								<c:out value="${requestScope.errores.get('idAutor')}" escapeXml="false"/>
